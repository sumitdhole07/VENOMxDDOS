...
API_TOKEN = '7325351596:AAHQ4vYsPtt9R_hjawfPZfOM-AS5wi4lX2Q'

AUTHORIZED_USERS = {"6638229469"}
...
async def user_info(message: Message):
    ...
    if user_data:
        ...
        approval_expiry_str = "𝙊𝙥𝙥𝙨 𝙉𝙤𝙩 𝙖𝙥𝙥𝙧𝙤𝙫𝙚𝙙 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 @sumit_dhole_07"
